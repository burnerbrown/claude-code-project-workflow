...
| A7 | Decision records | One decision record exists in `decision-records/` per major architecture decision, in the `step-1-concept.md` "Project Decision Records" format (formerly ADRs) |
