...
1. **DFM Summary**: Overall assessment (PASS / PASS WITH NOTES / NEEDS REVISION) and target manufacturing tier assumed (budget/standard/advanced). Note: QG evaluates per-criterion (DFM1–DFM10) and produces the canonical routing verdict.
