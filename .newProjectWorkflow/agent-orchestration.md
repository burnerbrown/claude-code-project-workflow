...
QG criteria to evaluate: {role-appropriate criteria block — look the role up in quality-gate.md's role-to-file index, then read its `_qg-criteria-*.md` companion file; e.g., P1-P5 for Senior Programmer, T1-T12 for Test Engineer}
